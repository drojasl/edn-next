...
const handleSubmit = async () => {
  ...
  if (result.success && result.data) {
    ...
    localStorage.setItem('course_access', JSON.stringify({
...
<template>
  <div class="min-h-screen relative flex items-center justify-center overflow-hidden bg-slate-900">
    ...
    <div class="absolute inset-0 z-0">
      ...
      <div class="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-indigo-600/30 rounded-full blur-[120px] animate-blob"></div>
      <div class="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-purple-600/30 rounded-full blur-[120px] animate-blob animation-delay-2000"></div>
    </div>
    ...
    <div class="relative z-10 w-full max-w-lg px-6">
      <div class="backdrop-blur-2xl bg-white/10 border border-white/20 rounded-[2.5rem] p-10 shadow-2xl space-y-10 text-center">
        <!-- Logo or Icon -->
