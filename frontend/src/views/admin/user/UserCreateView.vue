...
<template>
  <div class="max-w-4xl mx-auto py-4 sm:py-0">
    ...
    <!-- Error Message -->
    <div v-if="errorMessage" class="mb-8 p-4 bg-red-50 border border-red-200 rounded-xl text-red-700 flex items-start gap-3 fade-in">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-4 sm:p-8">
      <EntrepreneurForm 
        mode="create" 
        :loading="loading" 
        @submit="handleCreate" 
