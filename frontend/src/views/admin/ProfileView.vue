...
<template>
  <div class="max-w-4xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div class="space-y-6">
        <div
          class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 text-center sticky top-24"
        >
          <div
          ...
          >
            <div
              class="w-full h-full bg-indigo-50 text-indigo-600 rounded-full flex items-center justify-center border-4 border-white shadow-lg overflow-hidden relative"
            >
              <div
              ...
              <img
                ...
                :src="
                  ...
                  getFullUrl(authStore.user?.profile_picture || '')
                "
                alt="Avatar"
          ...
          <div class="mt-4 pt-4 border-t border-slate-50 text-left space-y-3">
            ...
            <div v-if="authStore.user?.slug">
              <p
                class="text-[10px] font-bold text-slate-400 uppercase tracking-widest"
              >
                {{ t('profile.slug_label') }}
              </p>
              <p class="text-sm font-medium text-indigo-600">
                /cursos/{{ authStore.user?.slug }}
              </p>
            </div>
          </div>
        </div>
