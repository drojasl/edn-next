    ...
    <AdminPageHeader :title="$t('course.management.title')">
      <template #actions>
        <div class="flex items-center gap-2 w-full sm:w-auto">
          ...
          />
          <button
            class="flex-1 sm:flex-none px-4 py-2.5 bg-white text-slate-700 border border-slate-200 rounded-xl hover:bg-slate-50 font-bold transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            :disabled="isSaving"
            @click="triggerImport"
          >
            <svg
          ...
          <button
            class="flex-1 sm:flex-none px-5 py-2.5 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 font-bold shadow-lg shadow-indigo-100 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            :disabled="isSaving"
