...
const navItems = [
  ...
  {
    name: 'admin.nav.prospects',
    path: '/admin/prospectos',
    icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z',
  },
  {
    name: 'admin.nav.courses',
    path: '/admin/cursos',
    icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253',
  },
  {
    name: 'admin.nav.codes',
    path: '/admin/codigos',
  ...
  <div class="min-h-screen bg-slate-50 flex flex-col">
        ...
        <div class="flex justify-between h-16">
          ...
          <div class="flex items-center gap-3">
            ...
            <router-link to="/admin" class="flex items-center gap-2 group">
              <div
                class="w-9 h-9 sm:w-10 sm:h-10 bg-indigo-600 rounded-xl flex items-center justify-center shadow-lg shadow-indigo-100 group-hover:scale-105 transition-transform"
              >
                <span class="text-white font-black text-lg sm:text-xl">E</span>
              </div>
              <span
                class="text-lg sm:text-xl font-bold bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent hidden xs:block"
              >
                {{ $t('admin.nav.title') }}
              </span>
            </router-link>
            ...
            <div class="relative">
              ...
              >
                <div class="text-right hidden sm:block">
                  ...
                  <p
                    class="text-xs text-slate-500 mt-1 uppercase tracking-wider font-medium"
                  >
                    {{ authStore.user?.codigo_amway }}
                  </p>
                </div>
                <div
                  class="w-9 h-9 bg-slate-100 border border-slate-200 rounded-full flex items-center justify-center text-slate-600 transition-transform"
                  :class="{ 'ring-2 ring-indigo-500': isUserMenuOpen }"
                >
                  <svg
                    class="w-5 h-5"
                    fill="none"
    ...
    >
      <div v-if="isMobileMenuOpen" class="fixed inset-0 z-[60] md:hidden">
        ...
        <nav
          class="relative w-72 max-w-[80vw] h-full bg-white shadow-2xl flex flex-col pt-5 pb-8 overflow-y-auto"
        >
          <div
            class="px-6 pb-6 border-b border-slate-100 flex items-center justify-between"
          >
          ...
          <div class="mt-auto px-6 pt-6 border-t border-slate-100">
            <p
              class="text-[10px] uppercase font-bold text-slate-400 tracking-widest mb-4"
            >
              EDN ADMIN v1.0
            </p>
            <button
