                            ...
                            <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                <div class="sm:flex sm:items-start">
                                    <div 
                                        ...
                                        :class="config.isDestructive ? 'bg-red-100 text-red-600' : 'bg-indigo-100 text-indigo-600'"
                                    >
                                        <svg v-if="config.isDestructive" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="h-6 w-6">
                                    ...
                                    <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                        <h3 class="text-lg font-bold leading-6 text-slate-800" id="modal-title">{{ config.title }}</h3>
