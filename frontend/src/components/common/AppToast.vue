...
<template>
    <Teleport to="body">
        ...
        >
            <div v-if="state.show" class="fixed top-4 right-4 z-[99999] pointer-events-none sm:top-5 sm:right-5">
                <div 
                    ...
                    <div class="p-4">
                        <div class="flex items-start">
                            <div class="flex-shrink-0">
                                <!-- Success Icon -->
                                <svg v-if="state.type === 'success'" class="h-6 w-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <div class="ml-3 flex-1 pt-0.5">
                                <p class="text-sm font-bold text-slate-900">
                                    {{ state.type === 'success' ? $t('toast.success_title') : $t('toast.error_title') }}
                                </p>
                                <p class="mt-1 text-sm font-medium text-slate-500 leading-relaxed">
                                    {{ state.message }}
                                </p>
                            </div>
